...
const BUILTIN_INTENT_CATALOG = [
  ...
  // ── B2: intenciones desktop — el detector semántico nunca podía anticipar
  // abrir apps/sitios, reproducir medios ni observar el escritorio porque no
  // tenían ni una frase de ejemplo. Frases ES+EN, destinos genéricos (ningún
  // sitio/app hardcodeado como requisito: son ejemplos, el resolver decide).
  {
    action: 'launch_app',
    tool: 'launch_app',
    description: 'Abrir una aplicación instalada en el escritorio',
    phrases: [
  ...
  },
  {
    action: 'open_website',
    tool: 'open_website',
    description: 'Abrir un sitio web en el navegador visible',
    phrases: [
      'abre amazon',
      'abre la tienda en el navegador',
      'ábreme la página de la tienda',
      'abre este sitio web',
      'llévame a la página del producto',
      'open the website',
  ...
  },
  {
    action: 'play_media',
    tool: 'play_media',
    description: 'Buscar y reproducir un video o canción',
    phrases: [
      'reproduce un video de guitarra',
      'pon música para concentrarme',
      'busca y reproduce ese tema',
      'reprodúceme el tutorial',
      'play some music',
      'play that video',
  ...
  },
  {
    ...
    description: 'Observar la interfaz del escritorio o una ventana',
    phrases: [
      'mira qué hay en mi escritorio',
      'observa la ventana abierta',
      'qué ves en la pantalla',
      'revisa el estado de la aplicación',
      'look at my desktop',
      'check what window is open',
      'observa los controles de esta ventana',
      'dime qué botones hay en pantalla',
    ],
  },
  {
    action: 'explain_code',
