...
const TASK_PATTERNS = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /(?:abre|ábreme|abrir|ve|llévame)\s+(?:youtube|google|drive|gmail|whatsapp|github|spotify|calendar|maps)\b/i,
      /(?:youtube|spotify)\b[^\n]{0,120}\b(?:busca|buscar|reproduce|reproducir|pon|poner)\b/i,
