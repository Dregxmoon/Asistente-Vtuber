 ...
 * MISMO modelo multilingüe central (EmbedModel.js): cero dependencias nuevas,
 ...
 * fallback si los embeddings no están disponibles. Así ningún idioma nuevo
 * exige tocar código: el modelo ya lo entiende.
 */

const { EMBED_DIMS } = require('../grounding/EmbedModel.js');

// Umbrales sobre similitud coseno (mismo espacio que IntentDetector) +
// MARGEN sobre el segundo mejor dominio. Calibrados en vivo ES/EN/JA: los
// negativos reales quedan <0.40 o empatados ("hola" 0.45/0.40), y las tareas
// claras separan (margen típico >0.10). Si cambias de modelo, repite la
// calibración: los scores NO son portables.
