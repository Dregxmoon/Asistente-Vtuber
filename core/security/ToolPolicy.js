 ...
 *
 * Antes convivían cuatro listas mantenidas a mano que debían coincidir:
 ...
 *   4. `IrreversiblePolicy.isIrreversible()` (¿ni el scope de tarea la cubre?).
 ...
 *
 * impact:
 *   'high'    → siempre pide aprobación (salvo allow explícito / scope / Siempre).
 ...
 * alwaysPrompt: ni siquiera agent.autoApprove la salta (va a card siempre).
 */
