---
description: 'Revisión de código: identificar bugs, problemas de seguridad, performance, mantenibilidad y consistencia con las convenciones del proyecto. EN: code review to find bugs, security issues, performance and maintainability problems. Ejemplos: revisa este código, busca bugs en el archivo. EN examples: review this code, find bugs in the file'
version: '1.0.0'
domains: ['code']
---
