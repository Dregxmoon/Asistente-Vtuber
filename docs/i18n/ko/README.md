...
메모리, 임베딩, 환경설정 및 텔레메트리는 로컬에 저장되지만 Kaoru가 항상 완전한 오프라인인
것은 아닙니다. 선택된 컨텍스트는 설정된 LLM, 음성 서비스, 웹사이트 또는 통합 서비스로 전송될
수 있습니다. 데스크톱 권한은 앱, 브라우저, 화면, 포인터, 키보드, 프로세스 및 카메라별로 설정할
수 있습니다.

- [문서 센터](../../README.md)
- [개인정보 처리방침 — 스페인어](../../web/privacy.html)
- [이용약관 — 스페인어](../../web/terms.html)
